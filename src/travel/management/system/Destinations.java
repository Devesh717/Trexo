...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run() {
        ...
        String[] text = new String[] {"The Grand Palace", "Oceanview Resort", "Mountain Peak Inn", "Sunset Boulevard Hotel", "Royal Orchid Sultes", "The Heritage Haven", "Palm Grove Retreat", "Cityscape Residency", "Lakeside Villa Hotel", "Skyline Executive Hotel"};
